...
export function Modal({ isOpen, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-2xl w-full max-w-lg shadow-2xl flex flex-col max-h-[90vh]">
