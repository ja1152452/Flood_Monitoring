...
export const acceptBackupRequest      = (id)   => api.patch(`/sos/backup/${id}/accept`).then(r => r.data.data);
export const declineBackupRequest     = (id, reason) => api.patch(`/sos/backup/${id}/decline`, { reason }).then(r => r.data.data);
