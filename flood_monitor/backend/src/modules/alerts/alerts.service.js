...
const ESCALATION_MAP = {
  MONITOR: ['ADMIN', 'SUPER_ADMIN', 'PNP', 'BFP', 'COAST_GUARD', 'RHU', 'MDRRMO_RESPONDER', 'BARANGAY_OFFICIAL', 'RESCUE', 'CITIZEN'],
  ALERT: ['ADMIN', 'SUPER_ADMIN', 'PNP', 'BFP', 'COAST_GUARD', 'RHU', 'MDRRMO_RESPONDER', 'BARANGAY_OFFICIAL', 'RESCUE', 'CITIZEN'],
  EVACUATION: ['ADMIN', 'SUPER_ADMIN', 'PNP', 'BFP', 'COAST_GUARD', 'RHU', 'MDRRMO_RESPONDER', 'BARANGAY_OFFICIAL', 'RESCUE', 'CITIZEN'],
  CRITICAL: ['ADMIN', 'SUPER_ADMIN', 'PNP', 'BFP', 'COAST_GUARD', 'RHU', 'MDRRMO_RESPONDER', 'BARANGAY_OFFICIAL', 'RESCUE', 'CITIZEN'],
};

const RESPONDER_ROLES = new Set(['PNP', 'BFP', 'COAST_GUARD', 'RHU', 'MDRRMO_RESPONDER', 'BARANGAY_OFFICIAL', 'RESCUE']);
